...
class AuctionServiceTest {
	...
	public void getAllAuctions_successful() {
		...
		AuctionResponse response1 = new AuctionResponse(
				...
				"New York", "Red", "Automatic", "V6", 1000L, 5000L, 0L, 0L, List.of("image1.jpg"), AuctionStatus.ACTIVE,1,"jacob","shskf"
		);
		AuctionResponse response2 = new AuctionResponse(
				2, "Title2", LocalDate.now(), LocalDate.now().plusDays(5), 0L, "30,000 km",
				"Los Angeles", "Blue", "Manual", "V8", 2000L, 6000L, 0L, 0L, List.of("image2.jpg"), AuctionStatus.ACTIVE,1,"jacob","sfjk"
		);
		...
		Page<AuctionResponse> responsePage = auctionService.getAllAuctions(pageable,searchTerm, status);
